"use strict"; console.log("UI JS Banner: Executing..."); try {
"use strict";
(() => {
  ...
  function formatUnit(value, unit, baseFontSize = 16) {
    ...
    switch (unit) {
      ...
      case "curr":
        return `${value}`;
      case "rem":
        return `${parseFloat((value / baseFontSize).toFixed(4))}rem`;
      case "em":
        return `${parseFloat((value / baseFontSize).toFixed(4))}em`;
      default:
        return `${value}${unit}`;
    }
  }
  ...
  function rgbaToOklch(r, g, b, a) {
    try {
      ...
      const L = 0.2104542553 * l_cubeRoot + 0.793617785 * m_cubeRoot - 0.0040720468 * s_cubeRoot;
      const A = 1.9779984951 * l_cubeRoot - 2.428592205 * m_cubeRoot + 0.4505937099 * s_cubeRoot;
      const B = 0.0259040371 * l_cubeRoot + 0.7827717662 * m_cubeRoot - 0.808675766 * s_cubeRoot;
  ...
  // token-export.ts
  function generateExport(variables, options, collectionName) {
    switch (options.format) {
      case "css":
        return generateCSS(variables, options);
      case "scss":
        return generateSCSS(variables, options);
      case "json":
        return generateJSON(variables, options);
      case "dtcg":
        return generateDTCG(variables, options, collectionName);
      default:
  ...
  function processValue(v, options) {
    ...
    if (!isResolved && typeof rawValue === "string" && rawValue.startsWith("{") && rawValue.endsWith("}")) {
      ...
      switch (options.format) {
        ...
        case "json":
          return `{${normalizeDotName(rawName)}}`;
        // Non-spec JSON still uses brackets but normalized dots
        case "dtcg":
  ...
  var App = () => {
    ...
    const getDisplayValue = (v, modeId) => {
      ...
      let colorHex = "";
      if (isResolvedMode) {
        if (valObj.resolvedValue !== void 0 && valObj.resolvedValue !== null) {
    ...
    const displayedVariables = variables.map((v) => {
      ...
      const { text, isColor, colorValue } = targetModeId && targetModeId !== "all" ? getDisplayValue(v, targetModeId) : { text: null, isColor: false };
    ...
    return /* @__PURE__ */ React.createElement("div", { style: styles.container }, /* @__PURE__ */ React.createElement("div", { style: styles.header }, /* @__PURE__ */ React.createElement("div", { style: styles.titleRow }, /* @__PURE__ */ React.createElement("h1", { style: styles.title }, "Design Tokens Manager"), collections.length > 0 && /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        style: __spreadProps(__spreadValues({}, styles.tab), { borderBottom: activeTab === "specs" ? "2px solid #18a0fb" : "none", fontWeight: activeTab === "specs" ? 600 : 500 }),
    ...
    ))) : /* @__PURE__ */ React.createElement(React.Fragment, null, activeTab === "variables" && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12, padding: 12, background: "#fff", border: "1px solid #e5e5e5", borderRadius: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: styles.controlGroup }, /* @__PURE__ */ React.createElement("label", { style: styles.label }, "Collection"), /* @__PURE__ */ React.createElement(
      "select",
      {
        style: styles.select,
        value: selectedCollectionId,
      ...
      /* @__PURE__ */ React.createElement("option", { value: "", disabled: true }, "Select a collection..."),
      collections.map((c) => /* @__PURE__ */ React.createElement("option", { key: c.id, value: c.id }, c.name))
    )), modes.length > 0 && /* @__PURE__ */ React.createElement("div", { style: styles.controlGroup }, /* @__PURE__ */ React.createElement("label", { style: styles.label }, "Mode"), /* @__PURE__ */ React.createElement(
      "select",
      {
        style: styles.select,
    ...
    ))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, flexWrap: "wrap", borderTop: "1px solid #f5f5f5", paddingTop: 12 } }, /* @__PURE__ */ React.createElement("div", { style: styles.controlGroup }, /* @__PURE__ */ React.createElement("label", { style: styles.label }, "Color"), /* @__PURE__ */ React.createElement(
      "select",
      {
  ...
  try {
    ...
    if (rootElement) {
      ...
      root.render(/* @__PURE__ */ React.createElement(AppContainer, null));
    } else {
...
react-dom/cjs/react-dom.production.min.js:
   ...
   *)
*/
} catch (e) { console.error("CRITICAL UI JS ERROR:", e); }
